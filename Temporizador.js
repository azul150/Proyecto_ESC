...
// Función para iniciar sesión con temporizador
function loginWithTimer(fullname, companyId) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Reemplazar el evento de login original
    ...
    if (loginButton) {
        loginButton.addEventListener('click', function() {
            ...
            loginWithTimer(fullname, companyId);
        });
    }
